...
function sum(a, b) { //eslint-disable-line
    ...
    let addition = a + b;
    let answer = 'The sum of ' + a + ' and ' + b + ' is ' + addition + '.';
...
function multiply(a, b) { //eslint-disable-line
    let multiply = a * b;
    let answer1 = 'The product of ' + a + ' and ' + b + ' is ' + multiply + '.';
    return [multiply, answer1]
}
...
function sumArray(sumArr) { //eslint-disable-line
    ...
    let string3 = sumArr[0] + ',' + sumArr[1] + ',' + sumArr[2] + ' was passed in as an array of numbers, and ' + sum4 + ' is their sum' + '.'; 
